...
class Ui_WfsClient(object):
    def setupUi(self, WfsClient):
        ...
        self.chkECP = QtGui.QCheckBox(WfsClient)
        self.chkECP.setGeometry(QtCore.QRect(300, 60, 261, 17))
        self.chkECP.setObjectName(_fromUtf8("chkECP"))
    ...
    def retranslateUi(self, WfsClient):
        ...
        self.chkECP.setText(_translate("WfsClient", "SAML ECP required", None))
